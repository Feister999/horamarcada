      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Button variant="ghost" className="hidden sm:inline-flex" onClick={handleLoginClick}>
              Entrar
            </Button>
            <Button className="bg-primary hover:bg-primary/90 shadow-soft" onClick={handleSignupClick}>
              Começar Grátis
            </Button>
          </div>
        </div>
